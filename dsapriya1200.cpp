...
int gcd(vector<int>nums){
    int ans=1;
    int i=0;
     int n=nums.size();                // ye nahi practice kiya-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    int minval=nums[i];
        int maxval=nums[n-1]; 
...
unordered_map<int, int> memo;                // ye nahi practice kiya--------------------------------------------------------------------------------------------------------------------
...
int main() {
    int arr[] = {23, 34, 41, 4, 3, 2, 5, 12, 13, 16, 14}; // ye nahi practice kiya hai------------------------------------------------------------------------------------------------------------------
    int n = sizeof(arr) / sizeof(arr[0]);
